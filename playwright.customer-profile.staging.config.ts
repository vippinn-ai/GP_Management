...
export default defineConfig({
  ...
  testMatch: ["customer-profile-snapshot-parity.e2e.ts"],
  ...
  use: {
    baseURL, browserName: "chromium", channel: process.env.E2E_BROWSER_CHANNEL || "chrome",
    headless: process.env.E2E_HEADLESS !== "false", actionTimeout: 15_000, navigationTimeout: 30_000,
    trace: "off", screenshot: "only-on-failure", video: "retain-on-failure", locale: "en-IN", timezoneId: "Asia/Calcutta"
  }
});
