...
3. Verify client-immutable grants, source retention, installer-only derived reconciliation, RLS, SECURITY DEFINER ownership/search paths, and tenant isolation.
