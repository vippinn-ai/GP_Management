...
- [ ] Repair the quarantined S1/S2 QA continuation link. The first guarded attempt failed closed on a trigger-timestamp assertion and fully rolled back; a separately approved trigger-aware attempt remains required.
