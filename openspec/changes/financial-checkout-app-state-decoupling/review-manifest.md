...
- First-party text/configuration files: 279.
- Physical lines mechanically screened: 76,266.
- Semantic billing/data-gateway/compatibility hotspots: 216.
- Files with billing/financial vocabulary: 200.
- Files containing an `app_state`, `appState`, or base-version reference: 82; none remain in the unclassified bucket.
...
| --- | ---: | --- |
| Documentation or test reference | 38 | Evidence, characterization, or explicitly documented legacy behavior. |
