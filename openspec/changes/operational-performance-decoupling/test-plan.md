...
- Record browser-clock marks for session ready, realtime requested/ready, App-module completion, RPC requested/response, mapping, catch-up, and safe interaction. Across one fresh unique 30-load race, require safe p95 <=3,500 ms, max <=5,000 ms, LCP p75 <=2,500 ms, RPC p95 <=800 ms/max <=1,200 ms, catch-up-to-safe p95 <=100 ms/max <=200 ms, dependency depth <=2, and one critical RPC with no direct profile/organization/history/report/audit/full-app-state reads.
