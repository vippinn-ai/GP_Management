...
async function verifyDeployedStagingArtifact(baseUrl) {
  ...
  return { bundle: bundleUrl.pathname, sha256: createHash("sha256").update(bundle).digest("hex") };
}
...
console.log(JSON.stringify({
  runner: "release-b-financial-v2-staging-playwright",
...
const result = spawnSync(
  process.execPath,
  [cliPath, "test", "--config=playwright.financial-v2.staging.config.ts", ...args],
